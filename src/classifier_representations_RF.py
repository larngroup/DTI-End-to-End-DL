...
## Load Protein Sequences
   ...
   # Save RF Model
   pickle.dump(rf_clf,open('../Models/RF_Model_Representations.py','wb'))
#   rf_clf=pickle.load(open('./Models/RF_Model_Representations.py','rb'))
   ...
   # Metrics
   metric_values=metrics_function(True,True,True,True,False,pred_labels,rf_clf.predict_proba(data_test)[:,1],labels_test,cm)
   print(metric_values)